...
let projects =
    [
      {id: 1, name: "Project A", description: "A demo project without a sense"},
      {id: 2, name: "Project  B", description: "Chaning the world with this!"},
      {id: 3, name: "Project Renasus", description: "Just a fake"},
      {id: 4, name: "Eminet", description: "Home Automation"}
    ]
